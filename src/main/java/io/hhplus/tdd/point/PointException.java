...
/**
 * ErrorCode 기반의 포인트 시스템 비즈니스 예외 클래스입니다.
 * <p>
 ...
 * throw new PointException(ErrorCode.POINT_OVERFLOW, "1000");
 * </pre>
 * <p>
...
public class PointException extends RuntimeException {
    ...
    /**
     * ErrorCode를 기반으로 PointException을 생성합니다.
     *
    ...
    /**
     * ErrorCode와 동적 파라미터를 기반으로 PointException을 생성합니다.
     * <p>
     * 메시지 내의 {0}, {1} 등의 플레이스홀더가 args로 치환됩니다.
     *
     * @param errorCode 예외 발생 원인을 나타내는 에러 코드
     * @param args 메시지 포맷 파라미터 (예: 현재 잔액, 충전 가능 금액 등)
     */
